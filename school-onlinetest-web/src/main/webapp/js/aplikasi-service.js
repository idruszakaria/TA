...
.factory('PesertaService', ['$resource', '$http', function($resource, $http){
 ...
 .factory('NotifMailService', ['$resource', '$http', function($resource, $http){
        var service = {
            ...
            query: function(p, callback){ return this.mail.queryPage({"page.page": p, "page.size": 10}, callback) },
            save: function(obj){
                if(obj.id == null){
            ...
            sendMail: function(obj,obj2) {
                return $http.get('/notifications/email/send?destination=' + obj + '&content=' + obj2);
            }
        };
